...
const SrearchManufacturer = ({manufacturer, setManufacturer}: SearchManufacturerProps)  => {
                    ...
                    <Combobox.Options>
                        {
                            ...
                            //saving this option for an example of how to add an unexisting query
...
export default SrearchManufacturer